...
-(double)hoursFrom:(NSDate *)date calendar:(NSCalendar *)calendar;
-(double)minutesFrom:(NSDate *)date calendar:(NSCalendar *)calendar;
-(double)secondsFrom:(NSDate *)date calendar:(NSCalendar *)calendar;
